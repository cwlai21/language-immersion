...
const I18N = {
  en: {
    ...
    goalStreakSub: 'days goal met',
    goalStreakSubAll: 'days both goals met',
    ...
    monthly: 'Monthly',
    bySource: 'By Source',
    recentSessions: 'Recent Sessions (this week)',
    ...
    editAllInGroup: 'applies to all %n sessions',
    untitled: '(untitled)',
    weekPrefix: 'Wk of ',
    all: 'All',
    french: 'Français',
    ...
    shortsPooled: 'of Shorts, counted when the binge ends',
  ...
  fr: {
    ...
    goalStreakSub: 'jours objectif atteint',
    goalStreakSubAll: 'jours les deux objectifs atteints',
    ...
    monthly: 'Mensuel',
    bySource: 'Par source',
    recentSessions: 'Sessions récentes (cette semaine)',
    ...
    goalMetTip: 'Objectif atteint',
    goalMissTip: 'Objectif non atteint',
    ...
    editAllInGroup: 's’applique aux %n sessions',
    untitled: '(sans titre)',
    weekPrefix: 'Sem. du ',
    all: 'Tout',
    french: 'Français',
    ...
    shortsPooled: 'de Shorts, comptés à la fin du défilé',
