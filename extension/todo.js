...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { id: 'gen-easyfrench-vu', lang: 'fr', kind: '▶️', sec: 244, title: 'Easy French 1 - à Paris!',
      ...
      { id: 'gen-ricksteves-vu', lang: 'en', kind: '▶️', sec: 1569, title: 'French Riviera: Uniquely Chic',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'lyon-bouchons-vu', lang: 'fr', kind: '▶️', sec: 296, title: 'Un bouchon traditionnel comme on les aime',
      ...
      { id: 'lyon-bouchons-ch', lang: 'fr', kind: '▶️', sec: 2384, title: 'Enquête sur la capitale de la Bonne bouffe',
      ...
      { id: 'lyon-histoire-vu', lang: 'fr', kind: '▶️', sec: 1665, title: 'Lyon, ville lumière',
      ...
      { id: 'lyon-histoire-ch', lang: 'fr', kind: '▶️', sec: 3116, title: 'Fourvière, Fort de Bron… découvrez les secrets des monuments de Lyon ! | Documentaire complet',
      ...
      { id: 'lyon-halles-vu', lang: 'fr', kind: '▶️', sec: 1531, title: 'La cuisine lyonnaise avec Paul Bocuse et Petitrenaud 👨‍🍳 | INA Les recettes vintage',
      ...
      { id: 'lyon-halles-ch', lang: 'fr', kind: '▶️', sec: 2384, title: 'Halles de Lyon, au paradis des gourmands',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'mars-corbusier-vu', lang: 'fr', kind: '▶️', sec: 536, title: 'Le Corbusier - Unité d’Habitation Marseille pt 1',
      ...
      { id: 'mars-corbusier-ch', lang: 'fr', kind: '▶️', sec: 2948, title: 'La Cité Légendaire du Corbusier',
      ...
      { id: 'mars-bouillabaisse-vu', lang: 'fr', kind: '▶️', sec: 1053, title: 'La Bouillabaisse au Rayol Canadel avec le Chef André Del Monte',
      ...
      { id: 'mars-bouillabaisse-ch', lang: 'fr', kind: '▶️', sec: 1502, title: 'Terre de Gout :  La Bouillabaisse à Marseille',
      ...
      { id: 'mars-calanques-vu', lang: 'fr', kind: '▶️', sec: 1517, title: 'Marseille : Les sentinelles des Calanques | Feuilleton France 2',
      ...
      { id: 'mars-calanques-ch', lang: 'fr', kind: '▶️', sec: 3112, title: 'A la découverte des Calanques, joyau préservé des Marseillais',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'nice-cuisine-vu', lang: 'fr', kind: '▶️', sec: 216, title: 'Socca : de Nice bien sûr ! - La Quotidienne la suite',
      ...
      { id: 'nice-histoire-vu', lang: 'fr', kind: '▶️', sec: 375, title: 'L’histoire de NICE... A toute Berzingue !',
      ...
      { id: 'nice-histoire-ch', lang: 'fr', kind: '▶️', sec: 532, title: 'Week-end à Nice : le ciel bleu et la douceur de vivre',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bes-citadelle-vu', lang: 'fr', kind: '▶️', sec: 6148, title: 'Vauban, le roi et les forteresses - Secrets d’histoire',
      ...
      { id: 'bes-comte-vu', lang: 'fr', kind: '▶️', sec: 365, title: 'Le dernier producteur de comté à l’ancienne - Météo à la carte',
      ...
      { id: 'bes-comte-ch', lang: 'fr', kind: '▶️', sec: 1809, title: 'Les fromages AOP dans la tourmente | ARTE Regards',
      ...
      { id: 'bes-ronchamp-vu', lang: 'fr', kind: '▶️', sec: 647, title: 'RONCHAMP I LE CORBUSIER I A WALK THROUGH IN 4K',
      ...
      { id: 'bes-ronchamp-ch', lang: 'fr', kind: '▶️', sec: 132, title: 'Chapelle de Ronchamp : visite inédite de la coque dessinée par Le Corbusier',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'route-conduire-fr-vu', lang: 'fr', kind: '▶️', sec: 196, title: '20. LA PRIORITÉ DE DROITE',
      ...
      { id: 'route-conduire-fr-ch', lang: 'fr', kind: '▶️', sec: 343, title: 'INSERTION SUR AUTOROUTE - ASTUCE PERMIS #3',
      ...
      { id: 'route-vignette-vu', lang: 'fr', kind: '▶️', sec: 178, title: 'La vignette électronique pour les autoroutes suisses en bref',
      ...
      { id: 'route-vignette-ch', lang: 'en', kind: '▶️', sec: 758, title: 'HOW TO DRIVE IN SWITZERLAND: Must-know rules and tips for driving in Switzerland!',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'foot-om-vu', lang: 'fr', kind: '▶️', sec: 1598, title: 'OM - Leipzig | L’histoire d’un quart de finale 🔥',
      ...
      { id: 'foot-om-ch', lang: 'fr', kind: '▶️', sec: 4544, title: 'Olympique de Marseille : quand le milieu faisait la loi',
      ...
      { id: 'foot-ol-vu', lang: 'fr', kind: '▶️', sec: 1026, title: 'L’ÉPOPÉE DE LYON EN EUROPA LEAGUE 2016/2017',
      ...
      { id: 'foot-ol-ch', lang: 'fr', kind: '▶️', sec: 597, title: 'De condamné à la Coupe d’Europe : Retour sur le miracle lyonnais | 2023-24 | Ligue 1 Uber Eats',
      ...
      { id: 'foot-nice-servette-vu', lang: 'fr', kind: '▶️', sec: 1335, title: 'VISITE D’UN DES MEILLEURS CLUB DE HOCKEY D’EUROPE (ils m’ont impressionnés)',
      ...
      { id: 'foot-nice-servette-ch', lang: 'fr', kind: '▶️', sec: 200, title: 'L’histoire de l’OGC Nice en Coupe de France I FFF 2022',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'montre-suisse-vu', lang: 'en', kind: '▶️', sec: 789, title: 'Why Swiss watches made by Richard Mille, Patek Philippe are so expensive | 60 Minutes',
      ...
      { id: 'montre-lip-vu', lang: 'fr', kind: '▶️', sec: 849, title: 'Les montres Lip - Reportage - Visites privées',
      ...
      { id: 'montre-lip-ch', lang: 'fr', kind: '▶️', sec: 289, title: 'Le point sur Lip',
      ...
      { id: 'montre-besancon-vu', lang: 'fr', kind: '▶️', sec: 254, title: 'Les gardiens du temps, à Besançon',
      ...
      { id: 'montre-vallee-vu', lang: 'en', kind: '▶️', sec: 1641, title: 'Visiting Jaeger-LeCoultre’s Manufacture In Switzerland (Behind The Scenes Private Tour)',
      ...
      { id: 'montre-vallee-ch', lang: 'fr', kind: '▶️', sec: 3038, title: 'La fabuleuse histoire de la montre',
      ...
      { id: 'montre-quartz-vu', lang: 'fr', kind: '▶️', sec: 300, title: '"Suisse?" – Pourquoi les gens achètent des montres suisses super chères?',
      ...
      { id: 'montre-rolex-vu', lang: 'fr', kind: '▶️', sec: 1636, title: 'Rolex, la saga du roi de l’horlogerie',
      ...
      { id: 'montre-chaux-vu', lang: 'fr', kind: '▶️', sec: 173, title: 'La Chaux-de-Fonds',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'esc-perouges-vu', lang: 'fr', kind: '▶️', sec: 349, title: 'Pérouges, village, médiéval . Plus beau village de France',
      ...
      { id: 'esc-perouges-ch', lang: 'fr', kind: '▶️', sec: 211, title: 'Pérouges n°1 : historique',
      ...
      { id: 'esc-provence-vu', lang: 'fr', kind: '▶️', sec: 5394, title: 'Luberon de villages en villages - Échappées belles',
      ...
      { id: 'esc-provence-ch', lang: 'fr', kind: '▶️', sec: 2460, title: 'Lubéron et Alpilles, les pépites de la Provence',
      ...
      { id: 'esc-azur-vu', lang: 'fr', kind: '▶️', sec: 5446, title: 'La Côte d’Azur, de village en village',
      ...
      { id: 'esc-doubs-vu', lang: 'fr', kind: '▶️', sec: 65, title: 'BAUME-LES-MESSIEURS, UN CONCENTRE DE MERVEILLES !',
      ...
      { id: 'esc-doubs-ch', lang: 'fr', kind: '▶️', sec: 6570, title: 'Que découvrir entre les monts du Jura et la Saône ? - Des racines et des ailes - Documentaire',
      ...
      { id: 'esc-leman-vu', lang: 'fr', kind: '▶️', sec: 2326, title: 'Les milliardaires du Lac Léman',
      ...
      { id: 'esc-leman-ch', lang: 'fr', kind: '▶️', sec: 3510, title: 'La magie du Lac Léman',
      ...
      { id: 'esc-bern-vu', lang: 'fr', kind: '▶️', sec: 8064, title: 'Le plus beau village de 2026 est... - Le village préféré des Français 2026',
      ...
      { id: 'esc-bern-ch', lang: 'fr', kind: '▶️', sec: 554, title: 'Gordes - Région PACA - Stéphane Bern - Le village préféré des Français 2016',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'luxe-prigent-vu', lang: 'fr', kind: '▶️', sec: 3418, title: 'WOW! CHANEL: JOURNAL OF A COLLECTION! By Loic Prigent',
      ...
      { id: 'luxe-prigent-ch', lang: 'fr', kind: '▶️', sec: 177, title: 'In the Métiers d’art Ateliers With Loïc Prigent. Métiers d’art 2020/21 — CHANEL',
      ...
      { id: 'luxe-arnault-vu', lang: 'fr', kind: '▶️', sec: 6105, title: 'BERNARD ARNAULT : CONFESSIONS INÉDITES DU PATRON DU LUXE MONDIAL (empire, drames, rumeurs…)',
      ...
      { id: 'luxe-soie-vu', lang: 'fr', kind: '▶️', sec: 7123, title: 'Les révoltes des canuts (documentaire complet)',
      ...
      { id: 'luxe-soie-ch', lang: 'fr', kind: '▶️', sec: 371, title: 'Lyon, au fil de la soie',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'gen2-cern-vu', lang: 'fr', kind: '▶️', sec: 2134, title: 'Le LHC 💥🧲🔬 : J’ai visité le plus grand accélérateur de particules du monde !',
      ...
      { id: 'gen2-fondue-vu', lang: 'fr', kind: '▶️', sec: 602, title: 'Raclette : Française ou Suisse ?',
